  ...
  public void doTag() throws JspException, IOException {
    ...
    try {
      ...
      out.append("<div class='"
          ...
          + "<div class='add-splash' id='splash-"
          + item.number
          + "'>"
          + "Added to Cart!"
          + "</div>"
          ...
          + "/"
          + img
          + ".jpg' class='img-responsive img-thumbnail' />"
          + "</div>"
          + "</a>"
          + "<div class='cart-btn-container' align='right'>"
          + "<button type='button' class='btn btn-default btn-sm' onclick=\"fade('splash-"
          + item.number
          + "'); "
          + "doAddCart('"
          + item.name
